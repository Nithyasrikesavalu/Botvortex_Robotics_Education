...
const StudentsContent = () => {
  ...
  const coursesList = ["all", ...new Set(students.map((s) => s.enrolledCourse))];
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {students.length > 0 ? Math.round(students.reduce((acc, student) => acc + (student.progress || 0), 0) / students.length) : 0}%
              </p>
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-2xl font-bold text-gray-900">
                {students.filter(s => s.lastActive === "Active Now").length}
              </p>
