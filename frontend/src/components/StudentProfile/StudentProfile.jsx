        ...
        if (res.ok) {
          ...
          setStudentData((prev) => ({
            ...
            personal: {
              ...
              role: "Student",
              studentAccount:
                storedUser.username || prev.personal.studentAccount,
            },
            education: {
              ...prev.education,
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] p-4">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center lg:items-center gap-6">
            <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left w-full sm:w-auto">
              ...
              <div className="relative">
                <div className="w-24 h-24 bg-blue-50 border border-slate-200 rounded-xl flex items-center justify-center shadow-lg overflow-hidden shrink-0">
                  <img
                ...
                {editMode && (
                  <button className="absolute -bottom-2 -right-2 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-blue-700 transition-colors border-2 border-white">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mt-1 max-w-md">
                  {studentData.personal.role}
                </p>
                <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 mt-3">
                  <span className="bg-emerald-50 text-emerald-800 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                    Active
                  </span>
            ...
            <div className="flex gap-3 w-full lg:w-auto">
              {!editMode ? (
                <button
                  ...
                  className="w-full sm:w-auto bg-blue-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-sm transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  <button
                    ...
                    className="flex-1 sm:flex-none bg-white border border-slate-200 text-slate-700 text-white px-4 md:px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none bg-emerald-600 text-white px-4 md:px-6 py-3 rounded-xl font-semibold hover:shadow-lg hover:shadow-emerald-500/25 transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">
                    {studentData.personal.studentId}
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Tabs Navigation */}
        <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 mb-8 border border-slate-200 overflow-x-auto">
...
const InfoRow = ({ section, field, label, value, editMode, handleChange }) => (
  <div className="flex flex-col sm:flex-row gap-4 py-4 border-b border-gray-100 hover:bg-blue-50 transition-all duration-200 rounded-lg px-3">
    <span className="text-sm font-semibold text-gray-600 min-w-[180px] flex items-start sm:items-center">
      <span className="w-2 h-2 bg-blue-500 rounded-full mr-3 mt-2 sm:mt-0 flex-shrink-0"></span>
      {label}
    </span>
    {editMode ? (
      <input
        className="flex-1 border border-slate-200 bg-white px-4 py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
        value={value}
  ...
  <button
    ...
    className={`flex items-center gap-2 px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${
      activeTab === tab
        ...
        : "text-gray-600 hover:bg-indigo-50 hover:text-blue-600 border border-transparent hover:border-slate-200"
    }`}
  >
    {children}
  </button>
